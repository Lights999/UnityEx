...
namespace GoogleMobileAds.Common
{
    ...
    public void DummyOnAdLoaded()
    {
      this.OnAdLoaded(this, EventArgs.Empty);
    }

    public void DummyOnAdFailedToLoad(string errorReason)
    {
    ...
    public void DummyOnAdOpened()
    {
      this.OnAdOpening(this, EventArgs.Empty);
    }

    public void DummyOnAdClosed()
    {
      this.OnAdClosed(this, EventArgs.Empty);
    }

    public void DummyOnAdLeftApplication()
    {
      this.OnAdLeavingApplication(this, EventArgs.Empty);
    }

    public void DummyOnAdStarted()
    {
      this.OnAdStarted (this, EventArgs.Empty);
    }

    public void DummyOnAdRewarded()
    {
